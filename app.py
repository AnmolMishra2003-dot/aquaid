...
FISH_INFO = {
    "Bangus": {
        "habitat": "Brackish & marine waters",
        "avg_size": "30–100 cm",
        "status": "Least Concern"
    },
    "Big Head Carp": {
        "habitat": "Large freshwater rivers & lakes",
        "avg_size": "60–150 cm",
        "status": "Least Concern"
    },
    "Black Spotted Barb": {
    ...
    "Catfish": {
        "habitat": "Freshwater rivers, ponds, lakes",
        "avg_size": "20–100 cm",
        "status": "Varies by species"
    },
    "Climbing Perch": {
        "habitat": "Swamps, ponds, slow rivers",
        "avg_size": "15–25 cm",
        "status": "Least Concern"
    },
    ...
    "Freshwater Eel": {
        "habitat": "Rivers & freshwater streams",
        "avg_size": "40–150 cm",
        "status": "Near Threatened"
    },
    "Glass Perchlet": {
        "habitat": "Freshwater & brackish waters",
        "avg_size": "4–8 cm",
        "status": "Least Concern"
    },
    "Goby": {
        "habitat": "Marine & freshwater habitats",
        "avg_size": "5–20 cm",
        "status": "Least Concern"
    },
    "Gold Fish": {
        "habitat": "Aquarium / ponds",
        "avg_size": "10–30 cm",
        "status": "Domesticated"
    },
    "Gourami": {
    ...
    "Indo-Pacific Tarpon": {
        "habitat": "Coastal & estuarine waters",
        "avg_size": "60–150 cm",
        "status": "Least Concern"
    },
    "Jaguar Gapote": {
    ...
    "Knifefish": {
        "habitat": "Slow freshwater rivers",
        "avg_size": "20–50 cm",
        "status": "Least Concern"
    },
    "Long-Snouted Pipeship": {
    ...
    "Mudfish": {
        "habitat": "Swamps & muddy freshwater",
        "avg_size": "30–90 cm",
        "status": "Least Concern"
    },
    "Mullet": {
    ...
    "Pangasius": {
        "habitat": "Large rivers (Mekong etc.)",
        "avg_size": "50–130 cm",
        "status": "Least Concern"
    },
    "Perch": {
...
def get_weather(lat, lon):
    try:
        ...
        print("WEATHER API RESPONSE:", data)  # DEBUG (important)
